...
function About() {
  return (
    <div className='flex flex-col md:flex-row items-center justify-between min-h-150 h-full pt-4 pb-20 w-full dark:bg-slate-800/90 dark:text-slate-200/70'>
      ...
      <div className='md:w-[40%] w-80  mx-4 '>
